        ...
        <input type="hidden" name="_token" :value="csrf">
         ...
         <input type="text" name="type" value="Idea" hidden>
            ...
            <section id="four" class="row" style="margin-bottom: 10px; display: none;" v-show="four">
                ...
                <div class="col-xs-12 col-sm-6 col-md-7 col-lg-4 offset-lg-4">
            ...
            <div class="form-group row">
                <label for="phone" class="col-xs-12 col-sm-4 col-md-2 col-lg-2 offset-lg-2 control-label">Phone <span class="asterisks">*</span></label>
                <div class="col-xs-12 col-sm-6 col-md-7 col-lg-4">
            ...
            <div class="form-group row">
                <label for="contactname" class="col-xs-12 col-sm-4 col-md-2 col-lg-2 offset-lg-2 control-label">Name <span class="asterisks">*</span></label>
                <div class="col-xs-12 col-sm-6 col-md-7 col-lg-4">
                    <input type="text" name="name" id="name" class="form-control" required placeholder="Name" required minlength="4">
                </div>
            </div>
             <div class="form-group row">
                <label for="email" class="col-xs-12 col-sm-4 col-md-2 col-lg-2 offset-lg-2 control-label">Email <span class="asterisks">*</span></label>
                <div class="col-xs-12 col-sm-6 col-md-7 col-lg-4">
                    <input type="text" name="email" id="email" class="form-control" required placeholder="Email Address" required="true">
                </div>
            </div>
            <div class="form-group row">
                <label for="password" class="col-xs-12 col-sm-4 col-md-2 col-lg-2 offset-lg-2 control-label">Password <span class="asterisks">*</span></label>
                <div class="col-xs-12 col-sm-6 col-md-7 col-lg-4">
