      ...
      <input type="hidden" name="_token" :value="csrf">
        <h4 class="text-center d-none">Request For Member</h4>
           ...
           <div class="form-group row">
                <label for="title" class="col-xs-12 col-sm-2 col-md-2 col-lg-2 offset-lg-2 control-labe">Startup Name<span class="asterisks">*</span></label>
             ...
             <div class="form-group row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-7 col-lg-4">
                     <input type="text" name="description" id="description" class="form-control" placeholder="Brief Description" minlength="4" required>
                </div>
            </div>
            <div class="form-group row">
