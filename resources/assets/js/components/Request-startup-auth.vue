    ...
    <form action="/request_team" method="POST" class="form-horizontal" role="form" id="startup" files="true" enctype="multipart/form-data">
        ...
        <h4 class="text-center d-none">Request For Member</h4>
            ...
            <div class="form-group row">
                <label for="title" class="col-xs-12 col-sm-2 col-md-2 col-lg-2 offset-lg-2 control-label">Startup Name<span class="asterisks">*</span></label>
             ...
             <div class="form-group row">
                <label for="description" class="col-xs-12 col-sm-2 col-md-2 col-lg-2 offset-lg-2 control-label">Brief Description <span class="asterisks">*</span></label>
                <div class="col-xs-12 col-sm-8 col-md-7 col-lg-4">
                     <input type="text" name="description" id="description" class="form-control" placeholder="Brief Decription" minlength="4" required>
                </div>
            </div>
            <div class="form-group row">
                <label for="company_name" class="col-xs-12 col-sm-2 col-md-2 col-lg-2 offset-lg-2 control-label">Category <span class="asterisks">*</span></label>
                <div class="col-xs-12 col-sm-8 col-md-7 col-lg-4">
                ...
                <label class="col-xs-12 col-sm-2 col-md-2 col-lg-2 offset-lg-2 control-label"><a href="#" class="btn" v-on:click="addtwo()" style="color:#27ad60;">Add Team Member <span class="glyphicon glyphicon-plus small" style="color:#27ad60;"></span></a></label>
                <div class="col-xs-12 col-sm-8 col-md-7 col-lg-4">
                    <input type="text" name="role1" id="role1" class="form-control" placeholder="Team member title e.g 'Developer'" minlength="4" required>
                </div>
                 <div class="col-xs-12 col-sm-8 col-md-7 col-lg-4 offset-lg-4">
            ...
            <section id="two" class="row two" style="margin-bottom: 10px; display: none;" v-show="two">
                <label class="col-xs-12 col-sm-2 col-md-2 col-lg-2 offset-lg-2 control-label"><a href="#" class="btn" v-on:click="addthree()" style="color:#27ad60;">Add Team Member <span class="glyphicon glyphicon-plus small" style="color:#27ad60;"></span></a></label>
                <div class="col-xs-12 col-sm-8 col-md-7 col-lg-4">
            ...
            <section id="three" class="row" style="margin-bottom: 10px; display: none;" v-show="three">
                <label class="col-xs-12 col-sm-2 col-md-2 col-lg-2 offset-lg-2 control-label"><a href="#" class="btn" v-on:click="addfour()" style="color:#27ad60;">Add Team Member <span class="glyphicon glyphicon-plus small" style="color:#27ad60;"></span></a></label>
                <div class="col-xs-12 col-sm-8 col-md-7 col-lg-4">
            ...
            <section id="four" class="row" style="margin-bottom: 10px; display: none;" v-show="four">
                 <label class="col-xs-12 col-sm-2 col-md-2 col-lg-2 offset-lg-2 control-label"><a href="#" class="btn">&nbsp;</a></label>
                <div class="col-xs-12 col-sm-8 col-md-7 col-lg-4">
            ...
            <div class="form-group row">
                <label for="additional" class="col-xs-12 col-sm-2 col-md-2 col-lg-2 offset-lg-2 control-label">Additional Info</label>
                <div class="col-xs-12 col-sm-8 col-md-7 col-lg-4">
                   <textarea placeholder="Additional Information" name="additional" id="additional" class="form-control"></textarea>
                </div>
            </div>
            <div class="form-group row">
                <label for="phone" class="col-xs-12 col-sm-2 col-md- col-lg-2 offset-lg-2 control-label">Phone <span class="asterisks">*</span></label>
                <div class="col-xs-12 col-sm-8 col-md-7 col-lg-4">
            ...
            <div class="form-group row">
                <label for="contactname" class="col-xs-12 col-sm-2 col-md-2 col-lg-2 offset-lg-2 control-label">Name <span class="asterisks">*</span></label>
                <div class="col-xs-12 col-sm-8 col-md-7 col-lg-4">
                    <input type="text" name="name" id="name" class="form-control" required placeholder="Name" required minlength="4">
                </div>
            </div>
             <div class="form-group row">
                <label for="email" class="col-xs-12 col-sm-2 col-md-2 col-lg-2 offset-lg-2 control-label">Email <span class="asterisks">*</span></label>
                <div class="col-xs-12 col-sm-8 col-md-7 col-lg-4">
                    <input type="text" name="email" id="email" class="form-control" required placeholder="Email Address" required="true">
                </div>
            </div>
            <div class="form-group row">
                <label for="password" class="col-xs-12 col-sm-2 col-md-2 col-lg-2 offset-lg-2 control-label">Password <span class="asterisks">*</span></label>
                <div class="col-xs-12 col-sm-8 col-md-7 col-lg-4">
             ...
             <div class="form-group row">
                <div class="col-xs-12 col-sm-8 col-md-7 col-lg-4 col-xs-offset-0 col-sm-offset-2 col-md-offset-2 offset-lg-4">
